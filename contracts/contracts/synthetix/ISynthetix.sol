...
interface ISynthetix {
    ...
    ) external returns (uint256 amountToMint, WrapperFeeData memory fees);
    ...
    function buy(
        ...
        uint256 minAmountReceived,
        address referrer
    ) external returns (uint256 synthAmount, WrapperFeeData memory fees);
    ...
    function sell(
        ...
        address referrer
    ) external returns (uint256 usdAmountReceived, WrapperFeeData memory fees);
}
